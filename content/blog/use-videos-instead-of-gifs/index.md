...
色々なブラウザが次々と対応する中でiOSだけは長らく非対応の姿勢を貫いてる。故スティーブ・ジョブズさんが「Googleのコーデックはめちゃくちゃだ」って言ったなんてこともあったみたい。
...
`コンテナ` `コーデック`の次にはなんと`ピクセルフォーマット`という各ピクセルの色情報についての形式があるんだけど、動画ファイルを変換する時はこれも指定しとかないとスマホで再生できなかったりする。
...
しかも`Netscape Navigator 2`の時代からあるやり方らしい。超古い。ネットスケープは1995年に発表された当時革新的だったブラウザなんだけど、知ってる？笑
...
それが今では普通に`video`タグ一発だからもう動画の表示にGIF画像を使う必要なんて無いってことなんだろうね。
